...
- [geographiclib-fortran](https://github.com/geographiclib/geographiclib-fortran) - Fortran implementation of the geodesic routines in GeographicLib.
...
- [Maptalks](https://github.com/maptalks/maptalks.js) - A light and plugable JavaScript library for integrated 2D/3D maps.
...
- [3dP](http://www.ogc.org/standards/3dp)
- [3D Tiles](http://www.ogc.org/standards/3DTiles)
- [ARML2.0](http://www.ogc.org/standards/arml)
- [Cat: ebRIM App Profile: Earth Observation Products](http://www.ogc.org/standards/cat2eoext4ebrim)
- [Catalogue Service](http://www.ogc.org/standards/cat)
- [CDB](http://www.ogc.org/standards/cdb)
- [CityGML](http://www.ogc.org/standards/citygml)
- [Coordinate Transformation](http://www.ogc.org/standards/ct)
- [Filter Encoding](http://www.ogc.org/standards/filter)
- [GeoAPI](http://www.ogc.org/standards/geoapi)
- [Geography Markup Language](http://www.ogc.org/standards/gml)
- [GeoPackage](http://www.ogc.org/standards/geopackage)
- [GeoRSS](http://www.ogc.org/standards/georss)
- [GeoSciML](http://www.ogc.org/standards/geosciml)
- [GeoSPARQL](http://www.ogc.org/standards/geosparql)
- [Geospatial eXtensible Access Control Markup Language (GeoXACML)](http://www.ogc.org/standards/geoxacml)
- [Geospatial User Feedback (GUF)](http://www.ogc.org/standards/guf)
- [GML in JPEG 2000](http://www.ogc.org/standards/gmljp2)
- [GroundwaterML](http://www.ogc.org/standards/gwml2)
- [i3s](http://www.ogc.org/standards/i3s)
- [IndoorGML](http://www.ogc.org/standards/indoorgml)
- [KML](http://www.ogc.org/standards/kml)
- [LandInfra/InfraGML](http://www.ogc.org/standards/infragml)
- [LAS](http://www.ogc.org/standards/LAS)
- [Location Services (OpenLS)](http://www.ogc.org/standards/ols)
- [Mapbox Vector Tile](https://github.com/mapbox/vector-tile-spec)
- [Moving Features](http://www.ogc.org/standards/movingfeatures)
- [NetCDF](http://www.ogc.org/standards/netcdf)
- [Observations and Measurements](http://www.ogc.org/standards/om)
- [OGC API - EDR](https://www.ogc.org/standards/ogcapi-edr)
...
- [Open GeoSMS](http://www.ogc.org/standards/opengeosms)
- [OpenMI](http://www.ogc.org/standards/openmi)
- [OpenSearch for EO](http://www.ogc.org/standards/opensearch-eo)
- [OpenSearch Geo](http://www.ogc.org/standards/opensearchgeo)
- [Ordering Services Framework for Earth Observation Products](http://www.ogc.org/standards/oseo)
- [OWS Context](http://www.ogc.org/standards/owc)
- [OWS Security](http://www.ogc.org/standards/security)
- [PipelineML](http://www.ogc.org/standards/pipelineml)
- [PubSub](http://www.ogc.org/standards/pubsub)
- [PUCK](http://www.ogc.org/standards/puck)
- [Sensor Model Language](http://www.ogc.org/standards/sensorml)
- [Sensor Observation Service](http://www.ogc.org/standards/sos)
- [Sensor Planning Service](http://www.ogc.org/standards/sps)
- [SensorThings](http://www.ogc.org/standards/sensorthings)
- [Simple Features](http://www.ogc.org/standards/sfa)
- [Simple Features CORBA](http://www.ogc.org/standards/sfc)
- [Simple Features OLE/COM](http://www.ogc.org/standards/sfo)
- [Simple Features SQL](http://www.ogc.org/standards/sfs)
- [SpatioTemporal Asset Catalogs](https://stacspec.org/)
- [Styled Layer Descriptor](http://www.ogc.org/standards/sld)
- [SWE Common Data Model](http://www.ogc.org/standards/swecommon)
- [SWE Service Model](http://www.ogc.org/standards/swes)
- [Symbology Encoding](http://www.ogc.org/standards/se)
- [Table Joining Service](http://www.ogc.org/standards/tjs)
- [TimeseriesML (tsml)](http://www.ogc.org/standards/tsml)
- [WaterML](http://www.ogc.org/standards/waterml)
- [Web Coverage Processing Service](http://www.ogc.org/standards/wcps)
- [Web Coverage Service](http://www.ogc.org/standards/wcs)
- [Web Feature Service](http://www.ogc.org/standards/wfs)
- [Web Map Context](http://www.ogc.org/standards/wmc)
- [Web Map Service](http://www.ogc.org/standards/wms)
- [Web Map Tile Service](http://www.ogc.org/standards/wmts)
- [Web Processing Service](http://www.ogc.org/standards/wps)
- [Web Service Common](http://www.ogc.org/standards/common)
- [WKT CRS](http://www.ogc.org/standards/wkt)
...
- **Communities**
  ...
  - [OGC](http://www.ogc.org/) - an international not for profit organization committed to making quality open standards for the global geospatial community
...
> 6. [Awesome GeoSpatial](https://github.com/sacridini/Awesome-Geospatial) - most Geospatial Library content come from this ropository.
